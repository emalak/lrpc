...
type StorageServiceClient interface {
	...
	GetSimilarPlaces(ctx context.Context, in *GetSimilarPlacesRequest, opts ...grpc.CallOption) (*GetSimilarPlacesResponse, error)
...
func (c *storageServiceClient) GetSimilarPlaces(ctx context.Context, in *GetSimilarPlacesRequest, opts ...grpc.CallOption) (*GetSimilarPlacesResponse, error) {
	out := new(GetSimilarPlacesResponse)
	err := c.cc.Invoke(ctx, "/landmark.storage.StorageService/GetSimilarPlaces", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) TestGetRecommended(ctx context.Context, in *TestGetFeedRequest, opts ...grpc.CallOption) (*TestGetFeedResponse, error) {
	out := new(TestGetFeedResponse)
	err := c.cc.Invoke(ctx, "/landmark.storage.StorageService/TestGetRecommended", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) SetNodeName(ctx context.Context, in *SetNodeNameRequest, opts ...grpc.CallOption) (*SetNodeNameResponse, error) {
	out := new(SetNodeNameResponse)
	err := c.cc.Invoke(ctx, "/landmark.storage.StorageService/SetNodeName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServiceServer interface {
	...
	GetSimilarPlaces(context.Context, *GetSimilarPlacesRequest) (*GetSimilarPlacesResponse, error)
...
func (UnimplementedStorageServiceServer) GetSimilarPlaces(context.Context, *GetSimilarPlacesRequest) (*GetSimilarPlacesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSimilarPlaces not implemented")
}
...
func (UnimplementedStorageServiceServer) TestGetRecommended(context.Context, *TestGetFeedRequest) (*TestGetFeedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestGetRecommended not implemented")
}
...
func _StorageService_GetSimilarPlaces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSimilarPlacesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServiceServer).GetSimilarPlaces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/landmark.storage.StorageService/GetSimilarPlaces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServiceServer).GetSimilarPlaces(ctx, req.(*GetSimilarPlacesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StorageService_TestGetRecommended_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestGetFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServiceServer).TestGetRecommended(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/landmark.storage.StorageService/TestGetRecommended",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServiceServer).TestGetRecommended(ctx, req.(*TestGetFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageService_SetNodeName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetNodeNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServiceServer).SetNodeName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/landmark.storage.StorageService/SetNodeName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServiceServer).SetNodeName(ctx, req.(*SetNodeNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StorageService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSimilarPlaces",
			Handler:    _StorageService_GetSimilarPlaces_Handler,
		},
		{
			MethodName: "AddUser",
		...
		},
		{
			...
			Handler:    _StorageService_TestGetRecommended_Handler,
		},
		{
